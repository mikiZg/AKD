package com.example.Projekt.AKD.v02;
...
public class ServerApplication {
    ...
    public ServerApplication inMemoryH2DatabaseServer() throws SQLException {
        return ServerApplication.createTcpServer("-tcp", "-tcpAllowOthers", "-tcpPort", "8081");
    }
}
